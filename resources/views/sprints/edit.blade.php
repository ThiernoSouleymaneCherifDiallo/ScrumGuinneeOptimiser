    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-md p-6">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">Modifier le sprint</h1>
            ...
            <form id="sprintForm" action="{{ route('projects.sprints.update', [$project, $sprint]) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        <!-- Nom du sprint -->
                        <div>
                            <label for="name" class="block text-sm font-medium text-gray-700">Nom du sprint</label>
                        ...
                        <div>
                            ...
                            <textarea name="goal" id="goal" rows="3"
                                      class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('goal', $sprint->goal) }}</textarea>
                            <p class="mt-1 text-xs text-gray-500">Décrivez l'objectif de ce sprint</p>
                            @error('goal')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">La suppression est irréversible. Soyez certain de votre action.</p>
                    </div>
