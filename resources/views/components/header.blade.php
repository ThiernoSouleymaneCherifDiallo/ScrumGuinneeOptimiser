    ...
    <div class="flex items-center justify-between p-4">
        ...
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                @yield('page-description', 'Bienvenue sur votre espace de travail')
            </p>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <button id="dark-mode-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
